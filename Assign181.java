/*Assignment 181: write a program on Size method in the Collection class.*/
...
public class Assign181
{
	public static void main(String[] args)
	{
		...
		System.out.println("Total No. Of Books: " + book1.size());
		System.out.println("Total No. Of Books: " + book2.size());
	}
}